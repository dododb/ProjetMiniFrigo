...
//Liste des PINs
int pinTempCannette= A0;
int pinTempPeltier= A1;
int pinCourantPeltier= 3;
int pinDHC22= BROCHE_CAPTEUR;
int led = 13;

//liste value pin
int pinTempCannetteValue=0;
int pinTempPeltierValue= 0;
int pinDHC22Value= 0;
...
//Temperature  
 void Temp(){
   ...
   pinTempCannetteValue = analogRead(pinTempCannette);
   pinTempPeltierValue = analogRead(pinTempPeltier);   
   
   Serial.print(":");
   Serial.print(pinTempPeltier);
   Serial.print(":");
   Serial.println(pinTempCannette);   
   //delay(1000);
}
